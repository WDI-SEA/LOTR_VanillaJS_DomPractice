...
function makeMiddleEarth() {
	...
	// this was just a log to see if our section was made properly(it was!)
	// console.log(section)
	...
	for (let i = 0; i < lands.length; i++) {
		...
		// we have an article, we have a name, now we tell our program to keep them together, with appendChild
